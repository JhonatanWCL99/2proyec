                                ...
                                <tbody>
                                    @foreach ($ventas as $venta)
                                        <tr>
                                            ...
                                            <td>{{ $venta->sucursal->nombre }} <br></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalAnulacion"><a href="{{$venta->id}}"></a> Anular Factura</button>
