                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card card-primary">
                                <br>
                                <form action="{{ route('productos_proveedores.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="producto_id">Seleccione el Producto<span
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="sucursal_id">Seleccione la Sucursal<span
                                                        class="required">*</span></label>
                                                <div class="selectric-hide-select">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="proveedor_id">Selecciona el Proveedor<span
                                                        class="required">*</span></label>
                                                <div class="selectric-hide-select">
