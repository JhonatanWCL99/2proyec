    ...
    <div class="section-body">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <a class="btn btn-primary" href="{{route('sanciones.create')}}">Asignar vacación</a><br><br>
                                    ...
                                    <td>
                                        <div class="dropdown" style="position: absolute;">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                ...
                                                <li><a href="#" class="dropdown-item" data-id="{{$vacacion->id}}" onclick="deleteItem(this)">Eliminar</a></li>
                                            </ul>
                                        </div>                                      
                                    </td>
                                </tr>
